...
<body>
	<div id="wrapper">
		<form:form commandName="reviewModel"
			action="/rentacar/review/modifySuccess.do"
			enctype="multipart/form-data" method="post">
			<input type="hidden" name="no" value="${reviewModel.no}" />
			<div id="page-wrapper">
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">이용후기 작성 글 수정 </h3>
							...
							<tbody>
								...
								<tr>
									...
									<td colspan=3><c:if
											...
											<img
												src="/rentacar/resources/reviewUpload/${reviewModel.imagefile_savname}"
												width="100" height="100" alt=""
												onerror="this.src='/rentacar/resources/images/noimg_130.gif'" />
