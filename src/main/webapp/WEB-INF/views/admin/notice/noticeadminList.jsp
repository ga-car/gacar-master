...
<body>
	<div class="row" style="padding-left: 15px; width: 900px;">
		<h1 class="page-header">고객센터관리 > 공지사항</h1>
	</div>
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">공지사항 검색, 수정, 삭제 기능하는 페이지입니다.</div>
				...
				<div class="dataTable_wrapper">
					<div id="dataTables-example_wrapper"
						...
						<div class="row" style="margin-bottom: 5px;">
							<div class="col-sm-6">
								<a href="/rentacar/admin/notify/list.do?searchNum=0&isSearch="><button
							...
							<div class="col-sm-12">
								<table
										...
										<tbody>
											...
											<tr class="gradeA even" role="row">
												...
												<td style="text-align: center; vertical-align: middle;"><a
													href="${viewURL}">${noticeList.subject}</a></td>
												...
												<td style="text-align: center; vertical-align: middle;"><fmt:formatDate
														value="${noticeList.regdate}" pattern="YY.MM.dd HH:mm" /></td>
									...
									<c:if test="${fn:length(noticeList) le 0}">
										<tbody>
											<tr>
												<td colspan="9" style="text-align: center;">등록된 게시물이
													없습니다</td>
											</tr>
										</tbody>
									</c:if>
