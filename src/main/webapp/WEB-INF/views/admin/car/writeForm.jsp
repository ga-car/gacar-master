...
<body>
	<form enctype="multipart/form-data" method="post">
		<table>
			...
			<tr>
				<td colspan="2"><input type="text" id="car_zipcode" name="car_zipcode"
					value="${rentacarModel.car_zipcode}" readonly />&nbsp;<a href="#"
			...
			<tr>
				<td colspan="2"><input type="text" id="car_addr" name="car_addr"
					value="${rentacarModel.addr}" readonly />
			</tr>
			<tr>
				<td colspan="2"><input type="text" id="car_addr2" name="car_addr2"
					value="${rentacarModel.addr2}" /><input type="hidden"
					name="car_lat" value="${rentacarModel.car_lat}" id="car_lat" /> <input
					type="hidden" name="car_lng" value="${rentacarModel.car_lng}"
					id="car_lng" /></td>
			</tr>
			<tr>
				<td>이미지</td>
