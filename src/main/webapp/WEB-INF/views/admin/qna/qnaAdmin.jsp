...
<body>
	<div class="row" style="padding-left: 15px; width: 900px;">
		<h1 class="page-header">고객센터관리 > 1:1문의</h1>
	</div>
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">1:1문의 검색, 수정, 삭제 기능하는 페이지입니다.</div>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<select class="form-control" name="sortNum"
									...
									<option value="/rentacar/admin/qna/list.do?sortNum=1">답변
										완료</option>
									<option value="/rentacar/admin/qna/list.do?sortNum=2">답변
										전</option>
								</select>
