...
<body>
	<c:if test="${session_email==null}">
		...
		<div class="sidebar-category-nav">
			...
			<ul class="nav">
				<li><a href="/rentacar/notify/list.do" class="link">
				<span class="nav-sidebar-label nav-sidebar-category-label">공지사항</span>
				<span class="nav-indicator nav-selected">
				<span class="nav-selected-dot"></span></span></a></li>

				<li><a href="/rentacar/faq/list.do" class="link">
				<span class="nav-sidebar-label nav-sidebar-category-label">FAQ</span>
				<span class="nav-indicator nav-selected ">
				<span class="nav-selected-dot"></span></span></a></li>

				<li><a href="/rentacar/qna/list.do" class="link">
