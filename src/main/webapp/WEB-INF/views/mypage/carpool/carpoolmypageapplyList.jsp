...
<div class="row" style="padding-left:15px;width:900px;">    
	<h1 class="page-header">카풀 신청자 내역</h1>
</div>
<div class="row">
					...
					<div class="row">
						<div class="col-sm-12">
							<table
								...
								<tbody>
								<c:if test= "${apemail == session_email }"> 
								<c:forEach var="attendList"  items="${attendList}" varStatus="stat">																			
									<tr class="gradeA even" role="row">
										...
										<c:url var="viewURL2" value="applydelete.do" >
								...
								<!--  등록된 상품이 없을때 -->
									<c:if test="${fn:length(attendList) le 0}">
										<tr><td colspan="9" style="text-align:center;">카풀 신청자 내역이 없습니다</td></tr>
									</c:if> 
								</tbody>
							</table>
					...
					<!-- <div class="row">
							<div style="text-align:center;">
								<div id="dataTables-example_filter" class="dataTables_filter">
									<form action="">
										<input type="hidden" class="form-control" name="searchNum" id="searchNum" value="2">
