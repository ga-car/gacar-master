	...
	<div class="tab_con" id="tab_con">
		<div class="find">
			<form action="emailFind.do" method="post" name="emailFindForm" onsubmit="return valueCheck()">
				<input type="hidden" value="${mem.email}" id="eValue" /> <input type="hidden" value="${isFind}" id="find" /> <input type="hidden" value="${mem.password}" id="pValue" />
				<fieldset>
					<h3>이메일 찾기</h3>
					<table>
						<tbody>
							...
							<tr>
								...
								<td><input type="text" class="txt w220" onkeyup="numCheck()" name="jumin1" id="jumin1" maxlength="6" /></td>
								<td>
				...
				<fieldset>
					...
					<table>
						<tbody>
							<tr>
								<th scope="row">이름</th>
								<td><input type="text" class="txt w220" name="name" id="name2" /></td>
							</tr>
							<tr>
								<th scope="row">이메일</th>
								<td><input type="text" class="txt w220" name="email" id="email" /></td>
