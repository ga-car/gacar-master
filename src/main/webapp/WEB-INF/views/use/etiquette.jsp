...
<link rel="shortcut icon" href="/rentacar/resources/images/service/favicon.ico" type="image/x-icon"/>
			...
			<div class="contentbox">		
				...
				<div class="location">
					<div class="location_in">
						<p><span>이용안내</span>&gt; <strong>이용 에티켓</strong></p>
					</div>
				</div>
				<div class="subtop-content bg_subvisual_01_02">
					<h3 class="subtit">이용안내</h3>
					<p class="subtxt"><strong>가입부터 결제까지 간편하게 이용 할 수 있는 가카</strong><br />합리적인 자동차생활의 제안! 가카 이용방법을 알려드립니다.</p>
				</div>
				<div class="bodystart">
<!-- bodystart -->
		<!-- 
					...
					<li class="etiquette03">
						<div class="bg-wrap">
							<div class="txt">
								...
								<p>가카의 모든 차량내 흡연은  절대금지되어 있습니다. </p>
