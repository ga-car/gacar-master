...
public class MemberController {
	...
	//@ModelAttribute("member") MemberModel member jsp에서 MemberModel객체의 변수명에 해당하는 값 들을 가져와서 member객체 생성, @ModelAttribute("member")는 jsp에서 member로 사용
	...
	public ModelAndView emailAuth2(HttpServletRequest request) throws Exception {
		...
		System.out.println("주민pre"+mem.getJumin1());
		System.out.println("주민:" +mem.getJumin1());*/
