...
public class Paging {
	...
	// Sort있는 생성자
		public Paging(int currentPage, int totalCount, int blockCount, int blockPage,String PageName, String sortNum){
			...
			if(currentPage > blockPage){
				if(sortNum != "")
					pagingHtml.append("<a class='page prv' href=" + PageName + ".do?currentPage=" + (startPage - 1) + "&sortNum="+sortNum+">");
				else                    
					pagingHtml.append("<a class='page prv' href=" + PageName + ".do?currentPage=" + (startPage - 1) + ">");
				pagingHtml.append("&lt;");
				pagingHtml.append("</a>");
		...
		// Search&Sort있는 생성자
		public Paging(int currentPage, int totalCount, int blockCount, int blockPage,String PageName, int searchNum, String isSearch, String sortNum){
			...
			if(currentPage > blockPage){
				if(isSearch != "")
					pagingHtml.append("<a class='page prv' href=" + PageName + ".do?currentPage=" + (startPage - 1) + "&searchNum="+searchNum+ "&isSearch="+isSearch+ "&sortNum="+sortNum+">");
				else                    
					pagingHtml.append("<a class='page prv' href=" + PageName + ".do?currentPage=" + (startPage - 1) + ">");
				pagingHtml.append("&lt;");
				pagingHtml.append("</a>");
